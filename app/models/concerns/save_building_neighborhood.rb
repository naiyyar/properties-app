module SaveBuildingNeighborhood
  ...
  #           neighborhood1 = neighborhood if neighborhood1.blank? and self.neighborhood.blank?
  #         end
          
  #         # if just_parent_neighborhoods.include? neighborhood
  #         #   neighborhood2 = neighborhood if neighborhood.blank?
  #         # end
          
  #         if parent_neighborhoods.include? neighborhood #checking parent of main neighborhood
  #           neighborhood2 = neighborhood if neighborhood2.blank? and self.neighborhoods_parent.blank?
  #           neighborhood1 = neighborhood if neighborhood1.blank? and neighborhood.blank?
  #         end
          
  #         if grandparent_neighborhoods.include? neighborhood #checking grandparent of main neighborhood
  #           neighborhood3 = neighborhood if neighborhood3.blank? and self.neighborhood3.blank?
  #           neighborhood2 = neighborhood if neighborhood2.blank? and neighborhood1.blank? and self.neighborhoods_parent.blank?
  #         end
