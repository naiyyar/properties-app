if @buildings.present?
	json.array!(@buildings) do |building|
	  json.(building, :id,:building_name, :building_street_address, :city, :state, :zipcode)
	 	...
	 	json.address building.building_street_address #for new listings form fields purpose
	 	json.management_company building.management_company.try(:name) #for new listings form fields purpose
