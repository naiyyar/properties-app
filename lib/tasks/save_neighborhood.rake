...
namespace :buildings do
  desc 'Refreshing each buildings neighborhood'
  task refresh_neighborhood: :environment do
    Building.all.find_each(batch_size: 200) do |building|
      building.get_and_save_neighborhood
    end
  end
end