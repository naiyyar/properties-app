Rails.application.routes.draw do
  ...
  get '/rent/:id/:address', to: 'featured_listings#show', as: :show_featured_listing
  ...
  resources :users do
    member do
      ...
      get '/frbotools/:type/:step',  to: 'users#featured_listings_steps', as: :edit_manager_featured_listing
  ...
  get '/advertise-with-us/:type/(:img)', to: 'home#advertise_with_us', as: :advertise_with_us
