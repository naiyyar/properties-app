...
Gcoordinate.where(zipcode: ['10029','10035','10128']).destroy_all
...
roosevelt.each do |coord|
	Gcoordinate.create(latitude: coord[:lat], longitude: coord[:lng], zipcode: 'Roosevelt Island')
end
...
stuyevesant.each do |coord|
	Gcoordinate.create(latitude: coord[:lat], longitude: coord[:lng], zipcode: 'Stuyevesant')
end
...
greenwich.each do |coord|
	Gcoordinate.create(latitude: coord[:lat], longitude: coord[:lng], zipcode: 'Greenwich Village')
end
...
gramercy.each do |coord|
	Gcoordinate.create(latitude: coord[:lat], longitude: coord[:lng], zipcode: 'Gramercy')
end
...
battery_park.each do |coord|
	Gcoordinate.create(latitude: coord[:lat], longitude: coord[:lng], zipcode: 'Battery Park')
end
...
flatiron.each do |coord|
	Gcoordinate.create(latitude: coord[:lat], longitude: coord[:lng], zipcode: 'Flatiron District')
end
...
chelsea.each do |coord|
	Gcoordinate.create(latitude: coord[:lat], longitude: coord[:lng], zipcode: 'Chelsea')
end
...
financial.each do |coord|
	Gcoordinate.create(latitude: coord[:lat], longitude: coord[:lng], zipcode: 'Financial District')
end
...
east_village.each do |coord|
	Gcoordinate.create(latitude: coord[:lat], longitude: coord[:lng], zipcode: 'East Village')
end
...
west_village.each do |coord|
	Gcoordinate.create(latitude: coord[:lat], longitude: coord[:lng], zipcode: 'West Village')
end
